...
public class ArithmeticOperations {
    ...
    public static void main(String[] args) {
        //変数の宣言・初期化
        int num1=550;//int型変数num1を宣言し、100を代入
        int num2=35;//int型変数num2を宣言し、10を代入
        ...
        //int型変数resultを宣言し、num3とnum4の加算結果を代入
        int result=num3+num4;
        //加算結果を出力
        System.out.println("num3+num4="+result);
        
        //resultにnum3とnum4の減算結果を代入
        result=num3-num4;
        //減算結果を出力
        System.out.println("num3-num4="+result);
        
        //resultにnum3とnum4の乗算結果を代入
        result=num3*num4;
        //乗算結果を出力
        System.out.println("num3*num4="+result);
        
        //resultに、num3とnum4の除算結果を代入
        result=num1/num2;
        //除算結果を出力
        System.out.println("num3/num4="+result);
        
        //resultに、num3とnum4の剰余算結果を代入
        result=num3%num4;
        //剰余算結果を出力
        System.out.println("num3%num4="+result);
